...
const CallRoom = ({video,audio,handleDisconnect}: Props) => {
    ...
    if(token ==="")
    {
        return <div className='w-full h-full flex flex-col justify-center
         items-center'>
            ...
            <p
            className='text-sm text-foreground'>Joining Call...</p>
  ...
  return (
    <div className='w-full h-full'><LiveKitRoom data-lk-theme="default"
    serverUrl={process.env.NEXT_PUBLIC_LIVEKIT_URL} token={token}
